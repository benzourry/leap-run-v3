...
export const OAUTH = {
        ...
        LOGOUT_URI : "https://io.lda-app.marine.gov.my/logout",
        USER_URI : "https://io.lda-app.marine.gov.my/user/me",
        CALLBACK : full + "/#/" ,
        FINAL_URI: full + "/#/",
        TOKEN_GET: "https://io.lda-app.marine.gov.my/token/get",
        PRIVACY_POLICY: "https://1drv.ms/b/s!AotEjBTyvtX0gq4fj9Ry8MLD1iskng?e=9SZVb2"
}

export const myRxStompConfig: RxStompConfig = {
        // brokerURL: 'wss://io.lda-app.marine.gov.my/ping/ws',
